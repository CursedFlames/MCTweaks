...
stonecutter {
    create(rootProject) {
        ...
        val release = combinations(listOf("1.21.3", "1.21.4", "1.21.5", "1.21.6", "1.21.7", "1.21.8", "1.21.9", "1.21.10", "1.21.11"), listOf("fabric", "neoforge"))

        val all = release.plus(listOf("26.1-snapshot-6-neoforge", "26.1-snapshot-7-fabric"))
        allVersions(all)
        mod("ModTemplate", all)
        mod("FastToolSwitching", all)
        mod("HopperBucket", all)
        mod("NametaggablePlayers", release)
