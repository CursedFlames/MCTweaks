...
val accessWidenerFile = file("build/generated/stonecutter/main/resources/${property("mod.id")}.official.accesswidener")
...
tasks {
    processResources {
        exclude("**/neoforge.mods.toml", "**/mods.toml", "**/accesstransformer.cfg", "**/*.named.accesswidener")
    }
